 ...
 */
function login() {
    return location.href = "http://192.168.2.174:8080/user/showLogin";
}
function regist() {
    return location.href = "http://192.168.2.174:8080/user/showRegister";
}
...
function search(a) {
    var b = "http://192.168.2.175:8082/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
