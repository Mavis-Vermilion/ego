...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="Kevin"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="15918888888"/>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">Kevin</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">159****8888</div>
							<div class="clr"></div>
						</div>
